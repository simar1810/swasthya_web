const page = () => {
  return (
    <div className="p-[2rem]">
      ...
      <p>Welcome to Swasthya Fitness!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Swasthya Fitnesst&apos;s Website, located at flextransformation.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Swasthya Fitness if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Swasthya Fitness, you agreed
        to use cookies in agreement with the Swasthya Fitness&apos;s Privacy
        Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Swasthya Fitness and/or its licensors own the
        intellectual property rights for all material on Swasthya Fitness. All
        intellectual property rights are reserved. You may access this from
        Swasthya Fitness for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Swasthya Fitness</li>
        <li>Sell, rent or sub-license material from Swasthya Fitness</li>
        <li>Reproduce, duplicate or copy material from Swasthya Fitness</li>
        <li>Redistribute content from Swasthya Fitness</li>
      </ul>
      ...
      <p>
        ...
        Swasthya Fitness does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Swasthya Fitness,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Swasthya Fitness
      ...
      <p>
        Swasthya Fitness reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Swasthya Fitness a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Swasthya Fitness; and (d) the
      ...
      <p>
        ...
        e-mail to Swasthya Fitness. Please include your name, your organization
      ...
      <p>
        No use of Swasthya Fitness&apos;s logo or other artwork will be allowed
